...
- Current branch/HEAD: `main`; feature commit `bee36ac` and Windows line-ending verification fix `bcff217` are integrated and pushed
...
- Recommended integration order: complete; no remaining worktree or merge dependency
- Delivery package: `docs/archive/chinese-factions/task.md`
- Next action: none; task branch deleted and records archived after successful integration and push
