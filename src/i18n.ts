...
export const UI_TEXT = {
  en: {
    ...
    help: {
      ...
      eyebrow: "User guide",
      title: "Create and keep your card",
      intro: "Build the card in the editor, then use the workspace to reference, save, or export it. This order keeps each step clear.",
      quickStart: "Recommended workflow",
      quickSteps: [
        {
          title: "Build the card face",
          body: "Choose the card type and nation in the left panel, then enter the title, text, keywords, and values.",
        },
        {
          title: "Adjust the artwork",
          body: "Upload an image or apply reference artwork. Drag inside the image area to reposition it and scroll to zoom.",
        },
        {
          title: "Save or export",
          body: "Save a project file if you want to edit again later. Open Export when you are ready to create PNG, JPG, or PDF output.",
        },
      ],
      workspaceTitle: "What each workspace tab does",
      workspaceItems: [
      ...
      saveTitle: "How to keep your work",
      saveItems: [
      ...
      referenceTitle: "Three ways to use a reference card",
      ...
      privacyTitle: "Local files and privacy",
  ...
  zh: {
    ...
    help: {
      ...
      eyebrow: "使用指南",
      title: "制作并保留你的卡牌",
      intro: "先在编辑区完成卡面，再通过工作台查找参考、保存项目或导出成品。按这个顺序操作，每一步都会更清楚。",
      quickStart: "推荐流程",
      quickSteps: [
        {
          title: "构建卡面",
          body: "在左栏选择卡种和阵营，再填写标题、正文、词条与数值。",
        },
        {
          title: "调整卡图",
          body: "上传图片或套用参考卡图。在图像区域拖动可调整位置，滚动鼠标滚轮可缩放。",
        },
        {
          title: "保存或导出",
          body: "需要以后继续编辑时，请先保存项目文件；需要成品时，再到“导出”生成 PNG、JPG 或 PDF。",
        },
      ],
      workspaceTitle: "工作台各自负责什么",
      workspaceItems: [
